...
public class Main {
    public static void main(String[] args) {
        ...
        Employee employee1 = new Employee(1,"Mehmet","Hazar");
        Employee employee2 = new Employee(2,"Ahmet","Yılmaz");
        Employee employee3 = new Employee(3,"Ali", "Demir");
        Employee employee4 = new Employee(4, "Zeynep","Durmaz");
        Employee employee5 = new Employee(5,"Feridun","Emir");
        Employee employee6 = new Employee(1,"Mehmet","Hazar");
